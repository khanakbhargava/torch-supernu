...
c      call pgmtxt('T',-1.75,.025,0,'Input: '//fdata)
      call pgsave
      call pgsci(2) 
c      call pgmtxt('T',-3.25,.025,0,'No.'//
c     $     dlabels(1)(:lnb(dlabels(1)))//': '//
c     $     dlabels(2)(:lnb(dlabels(2)))//' ('//
c     $     dlabels(3)(:lnb(dlabels(3)))//'; '// 
c     $     dlabels(4)(:lnb(dlabels(4)))//')'//' ; z='//
c     $     dlabels(5)(:lnb(dlabels(5)))//'\\(2233)'//
c     $     dlabels(6)(:lnb(dlabels(6))))
      call pgslw(5)          
